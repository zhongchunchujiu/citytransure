    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                <form class="form-horizontal" method="post" enctype="multipart/form-data"  action="/updateCommodity" >
                    <!-- 表单区域-->
                    <fieldset>
                        <!--表单主题-->
                        <legend>商品添加</legend>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input id="uploadPicture" name="file" type="file" class="file-loading">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input class="form-control" value="${commodity.name}" name="name" id="name" type="text"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input class="form-control" value="${commodity.price}" id="price" name="price" type="text"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <!-- label表示文字提示标签,可以通过表单的组建的id提示-->
                            ...
                            <div class="col-md-4">
                                <input class="form-control" id="discount" value="${commodity.discount}" name="discount" type="text"/>
                            </div>
                        </div>
