    ...
    <div class="zl-hd w1200">
        <c:choose>
            <c:when test="${sessionScope.user==null}">
                <p class="hd-p1 f-l" id="toptop">
                    Hi!您好，欢迎来到宅客微购，请登录  <a href="/toRegister">【免费注册】</a> | <a href="/toLogin">【登录】</a>
                </p>
            </c:when>
            <c:otherwise>
                <p class="hd-p1 f-l" id="toptop">
        ...
        <p class="hd-p2 f-r">
            <a href="index.jsp">返回首页</a><span>|</span>
            <a href="/toPersonal">个人中心</a><span>|</span>
            <a href="/toCart">我的购物车</a><span>|</span>
            <a href="/toOrder">我的订单</a>
        </p>
...
<div class="logo-search w1200">
    ...
    <div class="search f-r">
        ...
        <ul class="search-ul">
            <li><a href="/foodSearch/1">食品</a></li>
            <li><a href="/foodSearch/7">大米</a></li>
            <li><a href="/foodSearch/3">饮料</a></li>
            <li><a href="/foodSearch/2">酒水</a></li>
            <li><a href="/foodSearch/4">厨房调味</a></li>
            <li><a href="/foodSearch/5">洗浴用品</a></li>
            <li><a href="/foodSearch/6">纸品</a></li>
            <li><a href="/foodSearch/8">化妆品</a></li>
            <li><a href="/foodSearch/9">母婴</a></li>
            <li><a href="/foodSearch/10">家电</a></li>
            <li><a href="/foodSearch/11">玩具</a></li>
